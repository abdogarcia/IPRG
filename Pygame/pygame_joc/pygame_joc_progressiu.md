...
![Finestra inicial del joc](imatges/01_finestra.png)
...
![Primera versió: jugador i moneda](imatges/02_jugador_moneda.png)
...
![Jugador en moviment](imatges/03_moviment.png)
...
![Control dels límits de la finestra](imatges/04_limits.png)
...
![Col·lisió entre el jugador i la moneda](imatges/05_collisio_moneda.png)
...
![Marcador de puntuació](imatges/06_puntuacio.png)
...
![Puntuació i temps restant](imatges/07_temps.png)
...
![Enemic en moviment](imatges/08_enemic.png)
...
![Aspecte aproximat del joc complet](imatges/09_joc_final.png)
...
![Pantalla final de la partida](imatges/10_pantalla_final.png)
